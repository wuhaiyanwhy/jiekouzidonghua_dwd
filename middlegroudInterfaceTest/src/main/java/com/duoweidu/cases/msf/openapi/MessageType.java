    ...
    private void detailAssert() {
        ...
        if (model.notice.list.size() > 0) {
            for (int i = 0; i < model.notice.list.size(); i++) {
                ...
                assertNotNull("notice.list.get(i).related_id", model.notice.list.get(i).related_id);
                ...
                assertNotNull("notice.list.get(i).article_id", model.notice.list.get(i).article_id);
//                assertNotNull("notice.list.get(i).article_title", model.notice.list.get(i).article_title);
