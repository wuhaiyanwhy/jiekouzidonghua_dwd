...
public class Create extends InterfaceTest {
    ...
    public void msfCreate() {
        ...
        list.add(new BasicNameValuePair("accountTypeCode", SqlDetail.getParamValue(0, "msfCurrency")));
    ...
    public void iqgCreate() {
        List<NameValuePair> list = new LinkedList<>();
        list.add(new BasicNameValuePair("method", "account.create"));
        list.add(new BasicNameValuePair("accountTypeCode", SqlDetail.getParamValue(0, "iqgCurrency")));
        list.add(new BasicNameValuePair("availableAmount", "0"));
        list.add(new BasicNameValuePair("frozenAmount", "0"));
        list.add(new BasicNameValuePair("accountStatus", "2"));
        list.add(new BasicNameValuePair("multi", "0"));
    ...
    private void iqgDetailAssert() {
        ...
        detailAssertTest(SqlDetail.getParamValue(0, "iqgCurrency"), "account_type_code", model.account_type_code);
        detailAssertTest(SqlDetail.getParamValue(0, "iqgAccountTypeDesc"), "account_type_desc", model.account_type_desc);
        detailAssertTest(SqlDetail.getParamValue(0, "iqgCurrency"), "currency", model.currency);
        detailAssertTest("", "reverse", model.reverse);
    }
}
